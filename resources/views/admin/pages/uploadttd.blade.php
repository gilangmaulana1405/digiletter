                ...
                <form method="post" action="{{ route('change.ttdpimpinan') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <div class="input-group input-group-merge">
                                <textarea name="penanda_tangan" id="" class="form-control" placeholder="Masukkan penanda tangan" rows="4" required>{{ old('penanda_tangan') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="file" class="form-control" name="ttd_image" id="inputGroupFile02" onchange="previewFile()" required>
                            </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" id="nama_pimpinan" class="form-control" name="nama_pimpinan" placeholder="Masukkan nama pimpinan" value="{{ old('nama_pimpinan') }}" required />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="text" id="nomor_induk" class="form-control" name="nomor_induk" value="{{ old('nomor_induk')}}" placeholder="Cth: NIDN/NIP. 1990xxxxxxxx" required />
                            </div>
                        </div>
                    </div>
