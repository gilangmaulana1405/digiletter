...
$(function () {
    ...
    if (dt_ajax_table.length) {
        var dt_ajax = dt_ajax_table.dataTable({
            processing: true,
            ajax: assetsPath + '/template/assets/json/ajax.php',
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter = dt_filter_table.DataTable({
            ajax: assetsPath + '/template/assets/json/table-datatable.json',
            columns: [{
                    data: 'full_name'
                },
                {
    ...
    if (dt_adv_filter_table.length) {
        var dt_adv_filter = dt_adv_filter_table.DataTable({
            ...
            ajax: assetsPath + 'template/assets//template/assets/json/table-datatable.json',
            columns: [{
                    data: ''
                },
                {
